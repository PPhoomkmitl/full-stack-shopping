...
<body>
    ...
    <div class="container">
        ...
        <div id="canceled" class="tabcontent">
            <?php includeOrders("SELECT * FROM orders WHERE CusID = '$uid' AND shipping_status = 'Canceled' AND fullfill_status = 'Return'", $conn); ?>
        </div>
    ...
    function includeOrders($query , $conn) { 
        ...
        while ($row = mysqli_fetch_array($msresults)) {
                ...
                if($row['shipping_status'] == 'Inprogress') {
                    ...
                    echo $row['fullfill_status'] == 'Return' ? '('.$row['fullfill_status'].')' : '';
                    echo "</pl>";
